...
export const SERVICE_DATA = [
  ...
  },
  {
    ...
    text:
      "Aquisição e montagem de protótipos, pequenos lotes e lotes de produção."
  },
  {
    icon: "besit-icon-seo-report",
    title: "Montagem de Placas Eletrônicas",
    text:
      "Montagem de Placas eletrônicas em tecnologia THT e SMD."
  },
  {
    icon: "besit-icon-person",
    title: "Integração de Produtos",
    text:
      "Junção dos demais itens que integram o produto final."
  },
  {
...
export const REPRESENTANTES_DATA = [
  {
    ...
    endereco:"Anunciadores de Alarme Industrial e Sinalizadores de Eventos. - King, 386 – Ciudad de Buenos Aires (C1199AAB) – Argentina Contato: Ana V. Pappel",
  ...
  },
  {
    ...
    endereco:"Montagem de placas eletrônicas tecnologia SMD, BGA, PTH e Mistas, Anunciadores de Alarme Industrial, Sinalizador de Evento, Carregadores de Bateria, Fonte de alimentação;Rua Com. Mariano Torres, 168 – Ouro Verde",
  ...
  },
  {
    ...
    endereco:"Anunciador de Alarme industrial ME3011B Komplek Rukan Taman Meruya Blok M-51 & N15-16 Meruya Utara, Kembangan Jak- Bar 11620",
  ...
  },
  {
    pais:"Paraguai",
    nome:"BEIGEL S.R.L",
    endereco:"Placas eletrônicas, Chicotes elétricos e Produtos específicos. Anunciadores de Alarme Industrial e Sinalizadores de Eventos. 24 de Junio, 357 Y E. Gonzalez – Central Distrito Capital – Asuncion – Paraguay Contato: Pablo Uner / Edgar Uner",
  ...
  },
  {
    ...
    endereco:"EQUIPOS Y MATERIALES PARA INGENIERIA ELECTRICA ENDEREÇO: Parque Hernán Velarde N°86 - Cercado, Lima 1 - Perú",
  ...
  },
  {
    ...
    endereco:"Anunciador de Alarme industrial ME3011B Address : 9 Soi Petchkasem 77 Intersection 4 Petchkasem Road Nongkwang Plu, Nongkham District, Bangkok 10160",
