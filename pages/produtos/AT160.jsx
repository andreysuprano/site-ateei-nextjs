...
import AboutProduct from '@components/aboutAt160';
...
import BG_IMAGE from '@images/pageheader/2.png';
...
const BlogDetails = () => {
	return (
		<Layout pageTitle="Ateei Group | Produto">
			<HeaderOne />
			<MobileNav />
			<PageHeader title={`Carregador de Bateria AT160 FRN`} bgImage={BG_IMAGE} />
			<AboutProduct />
			<section
				style={{
					width: '100%',
					...
					<Tabs defaultActiveKey="manuais" id="uncontrolled-tab-example" className="mb-3">
						<Tab eventKey="manuais" title="Manuais">
							<Table responsive>
								...
								<tbody>
									{DOWNLOADS.filter((item) => item.produto == 'AT160')
