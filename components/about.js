					...
					<Col lg={6} className="col-lg-6 wow fadeInLeft" data-wow-duration="1500ms">
						<div className="about-one__images">
							...
							<div className="about-one__images-content text-center">
								<h3>+4500</h3>
								<p>Projetos Entregues em 2023</p>
							</div>
						</div>
					</Col>
					<Col lg={6}>
						<div className="about-one__content">
							...
							<p>
								Somos uma empresa de tecnologia que foca a gestão completa dos produtos eletrônicos dos
								Clientes.
							</p>
							<div className="about-one__box">
								...
								<div className="about-one__box-content">
									...
									<p>
										Atuamos desde o projeto e desenvolvimento, passando pela prototipagem, lotes
										pilotos e posteriores fases de maturação do produto e sua respectiva introdução
							...
							<div className="about-one__box">
								...
								<div className="about-one__box-content">
									...
									<p>
										A Ateei auxilia o Cliente gerenciando os projetos e dando suporte técnico e
										físico para que o produto possa ser lançado com efetividade no mercado.
									</p>
								</div>
							</div>
							...
							<div className="about-one__call">
								<ScrollLink
									...
									duration={500}
								>
									Solicitar um contato <i className="fa fa-arrow-circle-right" />{' '}
								</ScrollLink>
